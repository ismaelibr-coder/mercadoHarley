...
async function inspectShipmentResponse() {
    try {
        const melhorEnvioId = 'a0a84913-5dd2-4f7f-928d-e5e83cd2d2fa';

        console.log('🔍 Fetching shipment details...');
        console.log('   ID:', melhorEnvioId);

        const response = await axios.get(
            `https://melhorenvio.com.br/api/v2/me/shipments/${melhorEnvioId}`,
            {
                headers: {
